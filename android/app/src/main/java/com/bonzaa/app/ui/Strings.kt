...
object Strings {
    val en = mapOf(
        ...
        "share_vet" to "🩺 Share with vet",
        "vet_share_title" to "Possible food suspects",
        "vet_share_for" to "For %s",
        ...
        "sign_out_push_fail_title" to "Couldn't fully sign out of notifications",
        "sign_out_push_fail_msg" to "This device may keep receiving family notifications for this account for a while. Sign out anyway?",
        "sign_out_anyway" to "Sign out anyway",
        "hh_tagline" to "One family, one shared list of puppies",
        "hh_create_title" to "Start a family",
        "hh_join_title" to "Join a family",
        "hh_to_join" to "Have an invite code? Join instead",
        "hh_to_create" to "Don't have a code? Start a new family",
        "hh_name" to "Family name",
        "hh_create_btn" to "Create family",
        "hh_code" to "Invite code",
        "hh_join_btn" to "Join family",
        "hh_need_name" to "Give your family a name",
        "hh_need_code" to "Enter the invite code",
        "hh_panel_title" to "👨‍👩‍👧 Family",
        "hh_invite_label" to "Invite code — share this with family to add them",
        "hh_copy" to "Copy",
        "hh_copied" to "Copied!",
        "hh_members" to "Members",
        "hh_you" to "you",
        "hh_head" to "head",
        "hh_remove" to "Remove",
        "hh_leave" to "Leave family",
        "hh_leave_q" to "Leave this family?",
        "hh_leave_msg" to "You will need an invite code to rejoin.",
        ...
        "hh_pending_title" to "Request sent",
        "hh_pending_msg" to "Waiting for the head of \"%s\" to approve your request to join.",
        "hh_pending_msg_generic" to "Waiting for the head of the family to approve your request to join.",
        "hh_pending_cancel" to "Cancel request",
        "hh_join_requests" to "Waiting for approval",
        "hh_approve" to "Approve",
        "hh_decline" to "Decline",
        "hh_decline_q" to "Decline %s's request to join?",
    ...
    val ta = mapOf(
        ...
        "share_vet" to "🩺 மருத்துவரிடம் பகிர்",
        "vet_share_title" to "சாத்தியமான சந்தேக உணவுகள்",
        "vet_share_for" to "%s-க்கு",
        ...
        "sign_out_push_fail_title" to "அறிவிப்புகளிலிருந்து முழுமையாக வெளியேற முடியவில்லை",
        "sign_out_push_fail_msg" to "இந்த சாதனம் சிறிது நேரம் இந்த கணக்கிற்கான குடும்ப அறிவிப்புகளைத் தொடர்ந்து பெறக்கூடும். எப்படியும் வெளியேறவா?",
        "sign_out_anyway" to "எப்படியும் வெளியேறு",
        "hh_tagline" to "ஒரே குடும்பம் — பகிரப்பட்ட குட்டி பட்டியல்",
        "hh_create_title" to "குடும்பத்தை தொடங்கவும்",
        "hh_join_title" to "குடும்பத்தில் சேரவும்",
        "hh_to_join" to "அழைப்பு குறியீடு உள்ளதா? சேரவும்",
        "hh_to_create" to "குறியீடு இல்லையா? புதிய குடும்பத்தை தொடங்கவும்",
        "hh_name" to "குடும்பத்தின் பெயர்",
        "hh_create_btn" to "குடும்பத்தை உருவாக்கு",
        "hh_code" to "அழைப்பு குறியீடு",
        "hh_join_btn" to "குடும்பத்தில் சேர்",
        "hh_need_name" to "உங்கள் குடும்பத்திற்கு ஒரு பெயர் கொடுங்கள்",
        "hh_need_code" to "அழைப்பு குறியீட்டை உள்ளிடவும்",
        "hh_panel_title" to "👨‍👩‍👧 குடும்பம்",
        "hh_invite_label" to "அழைப்பு குறியீடு — குடும்பத்தினரை சேர்க்க இதை பகிரவும்",
        "hh_copy" to "நகலெடு",
        "hh_copied" to "நகலெடுக்கப்பட்டது!",
        "hh_members" to "உறுப்பினர்கள்",
        "hh_you" to "நீங்கள்",
        "hh_head" to "தலைவர்",
        "hh_remove" to "நீக்கு",
        "hh_leave" to "குடும்பத்தை விட்டு வெளியேறு",
        "hh_leave_q" to "இந்த குடும்பத்தை விட்டு வெளியேறவா?",
        "hh_leave_msg" to "மீண்டும் சேர அழைப்பு குறியீடு தேவைப்படும்.",
        ...
        "hh_pending_title" to "கோரிக்கை அனுப்பப்பட்டது",
        "hh_pending_msg" to "\"%s\" குடும்பத்தின் தலைவர் உங்கள் சேர்க்கை கோரிக்கையை அங்கீகரிக்க காத்திருக்கிறது.",
        "hh_pending_msg_generic" to "குடும்பத்தின் தலைவர் உங்கள் சேர்க்கை கோரிக்கையை அங்கீகரிக்க காத்திருக்கிறது.",
        "hh_pending_cancel" to "கோரிக்கையை ரத்து செய்",
        "hh_join_requests" to "அனுமதிக்காக காத்திருப்பவர்கள்",
        "hh_approve" to "அனுமதி",
        "hh_decline" to "நிராகரி",
        "hh_decline_q" to "%s-இன் சேர்க்கை கோரிக்கையை நிராகரிக்கவா?",
